...
import com.example.technologia.controller.request.ProduitRequest;
...
public class ProduitController {
	...
	// INSERT
	@PostMapping("/add")
	public ResponseJson addProduct(@RequestBody ProduitRequest p) {
		...
		produit.setDepot(this.dr.findById(p.getDepot()).get());
		
		
		
		this.pr.save(produit);
